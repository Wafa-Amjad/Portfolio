    ...
    return (
        <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                <div>
                    <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: '2rem' }}>Manage Skills</h2>
                    <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem' }}>Configure proficiency bars and technical categories</p>
                </div>
            ...
            <SideSheet
                ...
                subtitle="Record a technical skill name, category, and proficiency level."
            >
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={{ display: 'flex', gap: '12px' }}>
                        <button type="submit" className="btn-primary" style={{ flex: 1, justifyContent: 'center' }} disabled={loading}>
                            {loading ? 'Recording...' : 'Record Skill'}
                        </button>
